Shader "Custom/SdtSurfaceShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 c = lerp(tex2D (_MainTex, IN.uv_MainTex), tex2D(_SecondaryTexture, IN.uv_SecondaryTexture), _BlendRate) * _Color;
            o.Albedo = c.rgb;
            ...
            o.Emission = 1 - pow(abs(dot(viewDir, IN.worldNormal)), _Fresnel);
        }
        ENDCG
    }
    FallBack "Diffuse"
